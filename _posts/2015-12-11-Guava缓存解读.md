...
> * 仔细的翻源码，最好能有一个结构图出来(虽然开发工具可以很简便的把类的结构可视化)，如果你在看代码的过程中去记录这个核心类和比较复杂的源码结构，对我们学习是比较有帮助的，比如下图这样(虽然记录的比较简单，简陋)：

![guava-cache-str](http://xiaohuishu.net/static/post_image/guava-cache-str.png)
